                    ...
                    (USBMIDI_1_EP[USBMIDI_1_midi_in_ep].bufferSize - USBMIDI_1_EVENT_LENGTH))
        {
            ...
            else /* Only SysEx message is greater than 4 bytes */
            {
                ...
                do
                {
                    ...
                    USBMIDI_1_PrepareInBuffer(USBMIDI_1_MIDI_SYSEX, &midiMsg[idx],
                                                     USBMIDI_1_EVENT_BYTE3, cable);

                    /* Move to next 3 bytes of message */
                    ic  -= USBMIDI_1_EVENT_BYTE3;
                    idx += USBMIDI_1_EVENT_BYTE3;
                ...
                if (retError == USBMIDI_1_FALSE)
                {
                    ...
                    USBMIDI_1_PrepareInBuffer(USBMIDI_1_MIDI_EOSEX, &midiMsg[idx], ic, cable);
                }
            }
        }
        else
    ...
    *******************************************************************************/
                                                                 ...
                                                                 
    {
        ...
        else if (ic == USBMIDI_1_MIDI_EOSEX)
        {
            ...
            {
                case 0u:
                    USBMIDI_1_midiInBuffer[USBMIDI_1_midiInPointer] = USBMIDI_1_SYSEX_ENDS_WITH1 | cable;
                    USBMIDI_1_midiInPointer++;
                    ...
                    break;
                case 1u:
                    USBMIDI_1_midiInBuffer[USBMIDI_1_midiInPointer] = USBMIDI_1_SYSEX_ENDS_WITH2 | cable;
                    USBMIDI_1_midiInPointer++;
                    USBMIDI_1_midiInBuffer[USBMIDI_1_midiInPointer] = srcBuffZero;
                    USBMIDI_1_midiInPointer++;
                    USBMIDI_1_midiInBuffer[USBMIDI_1_midiInPointer] = USBMIDI_1_MIDI_EOSEX;
                    ...
                    break;
                case 2u:
                    USBMIDI_1_midiInBuffer[USBMIDI_1_midiInPointer] = USBMIDI_1_SYSEX_ENDS_WITH3 | cable;
                    USBMIDI_1_midiInPointer++;
                    USBMIDI_1_midiInBuffer[USBMIDI_1_midiInPointer] = srcBuffZero;
                    USBMIDI_1_midiInPointer++;
                    USBMIDI_1_midiInBuffer[USBMIDI_1_midiInPointer] = srcBuffOne;

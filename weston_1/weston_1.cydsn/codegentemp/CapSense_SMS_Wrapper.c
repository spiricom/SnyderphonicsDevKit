...
extern uint16 CapSense_noiseThreshold[CapSense_WIDGET_CSHL_PARAMETERS_COUNT];
extern uint16 CapSense_hysteresis[CapSense_WIDGET_CSHL_PARAMETERS_COUNT];
...
extern uint16 CapSense_fingerThreshold[CapSense_WIDGET_CSHL_PARAMETERS_COUNT];
...
uint16  * SMS_LIB_noiseThreshold = CapSense_noiseThreshold;
uint16 * SMS_LIB_hysteresis = CapSense_hysteresis;
...
uint16 * SMS_LIB_fingerThreshold = CapSense_fingerThreshold;

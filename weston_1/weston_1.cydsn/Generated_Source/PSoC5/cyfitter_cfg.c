...
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)0x4800064Cu)

/* IOPINS0_7 Address: CYREG_PRT12_DM0 Size (bytes): 8 */
#define BS_IOPINS0_7_VAL ((const uint8 CYFAR *)0x48000654u)
...
uint8 CYXDATA * const CYCODE CapSense_AMuxCH0__addrTable[29] = {
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE CapSense_AMuxCH0__maskTable[29] = {
	0x01u, 
	0x02u, 
	0x08u, 
	0x10u, 
